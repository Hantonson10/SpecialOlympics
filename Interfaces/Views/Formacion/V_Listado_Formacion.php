...
<div class="container">
       <div class="row">
           <div class="col-lg-12">
            <table id="tablaFormacion" class="table-striped table-bordered" style="width:100%;">
                ...
                <tbody>
                    ...
                    <tr> <!-- datos que va a mostrar -->
                        <td><?php echo $fila['formacion_nombre']?></td>
                        <td><?php echo $fila['formacion_descripcion']?></td>
                        <td><?php echo $fila['formacion_horas']?></td>
                        <td><?php echo $fila['formacion_entidad']?></td>
                    </tr>
                    <?php
                        }
                    ?>
