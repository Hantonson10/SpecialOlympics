...
<div class="container">
       <div class="row">
           <div class="col-lg-12">
            <table id="tablaActividad" class="table-striped table-bordered" style="width:100%;">
                ...
                <tbody>
                    ...
                    <tr> <!-- datos que va a mostrar -->
                        ...
                        <td><?php echo $fila['actividad_duracion']?></td>
                        <td><?php echo $fila['actividad_temporada']?></td>
