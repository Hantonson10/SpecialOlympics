...
<head>
    ...
    <script src="./Interfaces/js/jquery-3.6.0.js"></script>
    ...
    <script src="./Interfaces/js/login.js"></script>
    ...
    <div class="container-fluid">
        <div class="row g-0">
            <div class="col g-0">
                ...
                <img id="img1" src="./Interfaces/img/slider/photo1.jpg" width="100%" height="100%">
            ...
            <div class="col g-0">
                <div class="rightSide">
                <img id="logoBackgroundLogin"src="./Interfaces/img/icons/logoSOrender.png" width="100%" height="100%">
                <div id="loginForm" class="container py-5 h-100">
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-5 text-center">
                                ...
                                <button class="btn btn-outline-danger btn-lg px-5" type="submit">Login</button>
